...
class ItemCreated {
    ...
    constructor(id) { 
        ...
        ItemCreated.initialize(this, id);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ItemCreated.RequiredProperties) {
            if (!data[property]) {
...
ItemCreated.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
ItemCreated.prototype['id'] = undefined;

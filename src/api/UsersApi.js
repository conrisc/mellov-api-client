...
export default class UsersApi {
    ...
    */
     ...
     * Add tag
     * Add tag
     * @param {module:model/TagItem} tagItem Tag to add
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ItemCreated} and HTTP response
     */
    addTagWithHttpInfo(tagItem) {
      let postBody = tagItem;
      // verify the required parameter 'tagItem' is set
      if (tagItem === undefined || tagItem === null) {
        throw new Error("Missing the required parameter 'tagItem' when calling addTag");
      }
     ...
     */
    addTag(tagItem) {
      return this.addTagWithHttpInfo(tagItem)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
